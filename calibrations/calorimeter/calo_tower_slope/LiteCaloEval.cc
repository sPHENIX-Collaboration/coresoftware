...
//second draw_spectra f'n to accept an input and output file
void LiteCaloEval::draw_spectra_2(const char *infile, const char *outfile)
{
...
void LiteCaloEval::fit_info_2(const char *infile, const char * outfile, const int runNum)
{
