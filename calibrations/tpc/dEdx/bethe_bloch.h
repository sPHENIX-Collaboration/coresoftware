#ifndef BETHE_BLOCH_H_
#define BETHE_BLOCH_H_
...
inline double bethe_bloch_total(const double betagamma)
{
...
inline Double_t bethe_bloch_new_wrapper(const Double_t* const x, const Double_t* const par)
{
...
inline Double_t bethe_bloch_new_2D_wrapper(const Double_t* const x, const Double_t* const par)
{
  Double_t betagamma = x[0];
  Double_t A = par[0];
  Double_t B = par[1];
...
inline Double_t bethe_bloch_new_1D_wrapper(const Double_t* const x, const Double_t* const par)
{
  Double_t betagamma = x[0];
  Double_t A = par[0];
...
inline Double_t bethe_bloch_wrapper(const Double_t* const ln_bg, const Double_t* const par)
{
...
inline Double_t bethe_bloch_vs_p_wrapper(const Double_t* const x, const Double_t* const par)
{
  Double_t p = x[0];
  Double_t norm = par[0];
  Double_t m = par[1];
...
inline Double_t bethe_bloch_vs_logp_wrapper(const Double_t* const x, const Double_t* const par)
{
...
inline Double_t bethe_bloch_vs_p_wrapper_ZS(const Double_t* const x, const Double_t* const par)
{
  Double_t p = x[0];
  Double_t norm = par[0];
  Double_t m = par[1];
...
inline Double_t bethe_bloch_vs_p_wrapper_new(const Double_t* const x, const Double_t* const par)
{
  Double_t p = x[0];
  Double_t A = par[0];
  Double_t B = par[1];
...
inline Double_t bethe_bloch_vs_p_wrapper_new_2D(const Double_t* const x, const Double_t* const par)
{
  Double_t p = x[0];
  Double_t A = par[0];
  Double_t B = par[1];
...
inline Double_t bethe_bloch_vs_p_wrapper_new_1D(const Double_t* const x, const Double_t* const par)
{
  Double_t p = x[0];
  Double_t A = par[0];
  Double_t m = par[1];
...
inline Double_t bethe_bloch_vs_logp_wrapper_ZS(const Double_t* const x, const Double_t* const par)
{
  Double_t p = pow(10.,x[0]);
  Double_t norm = par[0];
  Double_t m = par[1];
...
inline Double_t bethe_bloch_vs_logp_wrapper_new(const Double_t* const x, const Double_t* const par)
{
  Double_t p = pow(10.,x[0]);
  Double_t A = par[0];
  Double_t B = par[1];
...
inline Double_t bethe_bloch_vs_logp_wrapper_new_1D(const Double_t* const x, const Double_t* const par)
{
  Double_t p = pow(10.,x[0]);
  Double_t A = par[0];
  Double_t m = par[1];
...
inline double dedx_ratio(const double p, const double m1, const double m2)
{
