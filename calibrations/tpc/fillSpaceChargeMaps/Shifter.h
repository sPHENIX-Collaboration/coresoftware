...
class Shifter
{
 public:
  ...
  TVector3 Shift(const TVector3 &position) const;
  TVector3 ShiftForward(const TVector3 &position) const;  // only shift with forward histogram
  TVector3 ShiftBack(const TVector3 &forwardshift) const;     //
