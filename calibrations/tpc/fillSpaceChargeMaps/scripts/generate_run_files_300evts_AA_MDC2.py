...
introduction = [
    ...
    "# and output.",
    "Initialdir      = /sphenix/user/shulga/Work/workfest2021_pull/coresoftware/calibrations/tpc/fillSpaceChargeMaps/",
    "",
...
for j, (start,end) in enumerate(zip(evt_start,evt_end)):
    ...
    ff_B.write("./add_histos_bX.py {} {}".format(j,int(evt_bX[j])))
    ff_B.close
