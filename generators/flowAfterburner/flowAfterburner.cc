...
float
calc_v2(double b, double eta, double pt)
{
  float a1, a2, a3, a4;
...
void
jjia_minbias_new (double b, double eta, double pt)
{
  v2 = calc_v2(b,eta,pt);
...
void
jjia_minbias_new_v2only (double b, double eta, double pt)
{
  v2 = calc_v2(b,eta,pt);
...
int
flowAfterburner(HepMC::GenEvent *event, 
