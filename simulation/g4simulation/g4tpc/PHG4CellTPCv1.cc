...
void PHG4CellTPCv1::add_edep(const PHG4HitDefs::keytype g4hitid, const int tbin, const float edep)
{
...
bool PHG4CellTPCv1::has_binning(const PHG4CellDefs::CellBinning binning) const
{
...
bool PHG4CellTPCv1::has_property(const PROPERTY prop_id) const
{
  prop_map_t::const_iterator i = prop_map.find(prop_id);
  return i != prop_map.end();
}

float PHG4CellTPCv1::get_property_float(const PROPERTY prop_id) const
{
...
int PHG4CellTPCv1::get_property_int(const PROPERTY prop_id) const
{
...
void PHG4CellTPCv1::add_property(const PROPERTY prop_id, const float value)
{
  if (!check_property(prop_id, type_float))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::add_property(const PROPERTY prop_id, const int value)
{
  if (!check_property(prop_id, type_int))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::add_property(const PROPERTY prop_id, const unsigned int value)
{
  if (!check_property(prop_id, type_uint))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::set_property(const PROPERTY prop_id, const float value)
{
  if (!check_property(prop_id, type_float))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::set_property(const PROPERTY prop_id, const int value)
{
  if (!check_property(prop_id, type_int))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::set_property(const PROPERTY prop_id, const unsigned int value)
{
  if (!check_property(prop_id, type_uint))
  {
    pair<const string, PROPERTY_TYPE> property_info = get_property_info(prop_id);
...
void PHG4CellTPCv1::print() const
{
  identify(cout);
}

void PHG4CellTPCv1::Reset()
{
  timeseq.clear();
  prop_map.clear();
  return;
