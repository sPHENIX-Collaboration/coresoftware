...
void PHG4TpcElectronDrift::fill_and_reset_trkrHitTruthClusters(std::array<TrkrTruthCentroidBuilder,55>& centroid_builder, 
    int& trkid, bool& has_energy_centroids) 
{
