...
{
  m_digitiser   ->DigitizeCylinderCells (m_topNode, m_hits, true,     m_verbosity);
  m_clusterizer ->ClusterCylinderCells  (m_topNode, /*do_read_raw=*/ false,  
      m_hits, clusters, /*b_truthtracks=*/ true, /*verbosity=*/ m_verbosity);
