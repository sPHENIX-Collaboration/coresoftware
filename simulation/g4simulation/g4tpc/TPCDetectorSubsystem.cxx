...
int TPCDetectorSubsystem::InitRunSubsystem( PHCompositeNode* node )
{
  ...
  PHG4HitContainer *phhits =  findNode::getClass<PHG4HitContainer>( node , "G4HIT_SVTX" );
  if( !phhits ) {
    phhits = new PHG4HitContainer();
    dstNode->addNode( new PHIODataNode<PHG4HitContainer>( phhits, "G4HIT_SVTX", "PHG4HitContainer" ));
  }
