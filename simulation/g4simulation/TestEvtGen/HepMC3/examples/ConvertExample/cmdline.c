/*
  ...
  /usr/local/bin/gengetopt -N --no-version --input=/Volumes/Work/HepMC3/examples/ConvertExample/cmdline.ggo --file-name cmdline --output-dir=/Volumes/Work/HepMC3/examples/ConvertExample --include-getopt --show-required --unnamed-opts=inputfile outputfile 
