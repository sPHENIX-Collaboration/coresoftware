...
void
PHG4FullProjSpacalCellReco::etasize_nslat(const int i, const double deltaeta, const int nslat)
{
  if (nslat >= 1)
    {
...
void
PHG4FullProjSpacalCellReco::set_size(const int i, const double sizeA, const int sizeB, const int what)
{
...
double
PHG4FullProjSpacalCellReco::get_phi_slat_zero_low(const double radius, const double thickness, const double tiltangle)
{
...
double
PHG4FullProjSpacalCellReco::get_phi_slat_zero_up(const double radius, const double thickness, const double tiltangle)
{
  // A/sin(alpha) = C/sin(gamma)
  // beta = 90-gamma
