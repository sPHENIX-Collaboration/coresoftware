#ifndef PHG4MapsTelescopeSubsystem_h
#define PHG4MapsTelescopeSubsystem_h
...
class PHG4MapsTelescopeSteppingAction;
class PHG4EventAction;

class PHG4MapsTelescopeSubsystem: public PHG4DetectorSubsystem
{

  public:

  //! constructor
  PHG4MapsTelescopeSubsystem( const std::string &name = "BLOCK", const int layer = 0 , int stave_type = 0);

  //! destructor
  virtual ~PHG4MapsTelescopeSubsystem( void )
  {}
...
//  void BlackHole(const int i=1) {blackhole = i;}
  ...
  PHG4MapsTelescopeSteppingAction* steppingAction_;
