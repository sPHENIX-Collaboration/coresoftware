...
//_______________________________________________________________________
int
PHG4ProjCrystalCalorimeterDetector::IsInCrystalCalorimeter(G4VPhysicalVolume * volume) const
{
...
int
PHG4ProjCrystalCalorimeterDetector::Fill4x4Unit(G4LogicalVolume *crystal_logic)
{
...
int
PHG4ProjCrystalCalorimeterDetector::FillSpecialUnit(G4LogicalVolume *crystal_logic, G4int ident)
{
...
//_______________________________________________________________________
int
PHG4ProjCrystalCalorimeterDetector::ConstructProjectiveCrystals(G4LogicalVolume* ecalenvelope)
{
