...
PHG4BbcSteppingAction::PHG4BbcSteppingAction(PHG4BbcDetector* detector, const PHParameters*)
...
//____________________________________________________________________________..
bool PHG4BbcSteppingAction::UserSteppingAction(const G4Step* aStep, bool)
{
  ...
  */
  ...
  case fPostStepDoItProc:
    ...
    [[fallthrough]]; // c++17 tell gcc/clang that no break is intended
