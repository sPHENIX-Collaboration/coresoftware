...
namespace
{
  ...
  using array_t = std::array<std::vector<double>, PHG4TpcGeomv1::NSides>;
...
std::ostream& operator<<(std::ostream& out, const PHG4TpcGeomv1& geom)
{
  out << "PHG4TpcGeomv1 - layer: " << geom.layer << std::endl;
  out
      << "  binnig: " << geom.binning
      << ", radius: " << geom.radius
      << ", nzbins: " << geom.nzbins
...
void PHG4TpcGeomv1::set_zbins(const int i)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  nzbins = i;
}

void PHG4TpcGeomv1::set_zmin(const double z)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  zmin = z;
}

int PHG4TpcGeomv1::get_zbins() const
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  return nzbins;
}
...
double
PHG4TpcGeomv1::get_zstep() const
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  return zstep;
}

void PHG4TpcGeomv1::set_zstep(const double z)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  zstep = z;
}

int PHG4TpcGeomv1::get_phibins() const
{
  check_binning_method_phi("PHG4TpcGeomv1::get_phibins");
  return nphibins;
}

double
PHG4TpcGeomv1::get_phistep() const
{
  check_binning_method_phi("PHG4TpcGeomv1::get_phistep");
  return phistep;
}

double
PHG4TpcGeomv1::get_phimin() const
{
  check_binning_method_phi("PHG4TpcGeomv1::get_phimin");
  return phimin;
}

void PHG4TpcGeomv1::set_phibins(const int i)
{
  check_binning_method_phi("PHG4TpcGeomv1::set_phibins");
  nphibins = i;
}
...
{
  check_binning_method_eta("PHG4TpcGeomv1::get_etabins");
  return nzbins;
}

double
PHG4TpcGeomv1::get_etastep() const
{
  check_binning_method_eta("PHG4TpcGeomv1::get_etastep");
  return zstep;
}
double
PHG4TpcGeomv1::get_etamin() const
{
  check_binning_method_eta("PHG4TpcGeomv1::get_etamin");
  return zmin;
}

void PHG4TpcGeomv1::set_etamin(const double z)
{
  check_binning_method_eta("PHG4TpcGeomv1::set_etamin");
  zmin = z;
}

void PHG4TpcGeomv1::set_etastep(const double z)
{
  check_binning_method_eta("PHG4TpcGeomv1::set_etastep");
  zstep = z;
}

void PHG4TpcGeomv1::set_etabins(const int i)
{
  check_binning_method_eta("PHG4TpcGeomv1::set_etabins");
  nzbins = i;
}

void PHG4TpcGeomv1::identify(std::ostream& os) const
{
  os << "PHG4TpcGeomv1::identify - layer: " << layer
     << ", radius: " << radius
     << ", thickness: " << thickness;
  switch (binning)
  {
...
PHG4TpcGeomv1::get_zbounds(const int ibin) const
{
...
std::pair<double, double>
PHG4TpcGeomv1::get_etabounds(const int ibin) const
{
  if (ibin < 0 || ibin > nzbins)
  {
    std::cout << PHWHERE << " Asking for invalid bin in z: " << ibin << std::endl;
  ...
  check_binning_method_eta("PHG4TpcGeomv1::get_etabounds");
...
std::pair<double, double>
PHG4TpcGeomv1::get_phibounds(const int ibin) const
{
...
int PHG4TpcGeomv1::get_zbin(const double z) const
{
...
int PHG4TpcGeomv1::get_etabin(const double eta) const
{
...
int PHG4TpcGeomv1::get_phibin_new(const double phi) const
{
  double norm_phi = phi;
...
int PHG4TpcGeomv1::find_phibin(const double phi, int side) const
{
  double norm_phi = phi;
  if (phi < phimin || phi > (phimin + nphibins * phistep))
  {
...
float PHG4TpcGeomv1::get_pad_float(const double phi, int side) const
{
  double norm_phi = phi;
  if (phi < phimin || phi > (phimin + nphibins * phistep))
  {
...
float PHG4TpcGeomv1::get_tbin_float(const double z) const
{
  if (z < zmin || z > (zmin + nzbins * zstep))
  {
    //    cout << PHWHERE << "Asking for bin for z outside of z range: " << z << endl;
...
int PHG4TpcGeomv1::get_phibin(const double phi, int side) const
{
  double new_phi = phi;
  if (phi > M_PI)
  {
...
double
PHG4TpcGeomv1::get_zcenter(const int ibin) const
{
  if (ibin < 0 || ibin > nzbins)
  {
    std::cout << PHWHERE << "Asking for invalid bin in z: " << ibin << std::endl;
...
double
PHG4TpcGeomv1::get_etacenter(const int ibin) const
{
  if (ibin < 0 || ibin > nzbins)
  {
...
double
PHG4TpcGeomv1::get_phicenter_new(const int ibin) const
{
  if (ibin < 0 || ibin > nphibins)
  {
    std::cout << PHWHERE << "Asking for invalid bin in phi: " << ibin << std::endl;
...
double
PHG4TpcGeomv1::get_phicenter(const int ibin, const int side) const
{
...
double
PHG4TpcGeomv1::get_phi(const float ibin, const int side) const
{
  // double phi_center = -999;
  if (ibin < 0 || ibin > nphibins)
  {
...
std::string
PHG4TpcGeomv1::methodname(const int i) const
{
  switch (i)
  {
  case PHG4CylinderCellDefs::sizebinning:
...
void PHG4TpcGeomv1::check_binning_method(const int i) const
{
  if (binning != i)
  {
...
void PHG4TpcGeomv1::check_binning_method_eta(const std::string& src) const
{
...
void PHG4TpcGeomv1::check_binning_method_phi(const std::string& src) const
{
  if (binning != PHG4CylinderCellDefs::etaphibinning &&
