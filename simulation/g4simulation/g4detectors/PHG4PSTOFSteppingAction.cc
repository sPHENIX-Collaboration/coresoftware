...
PHG4PSTOFSteppingAction::PHG4PSTOFSteppingAction(PHG4PSTOFDetector* detector, const PHParametersContainer*)
...
//____________________________________________________________________________..
bool PHG4PSTOFSteppingAction::UserSteppingAction(const G4Step* aStep, bool)
{
