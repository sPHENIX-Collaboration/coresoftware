...
PHG4sPHENIXMagnetSteppingAction::PHG4sPHENIXMagnetSteppingAction(PHG4sPHENIXMagnetDetector* detector, const PHParameters* parameters)
...
PHG4sPHENIXMagnetSteppingAction::~PHG4sPHENIXMagnetSteppingAction()
{
...
//____________________________________________________________________________..
bool PHG4sPHENIXMagnetSteppingAction::UserSteppingAction(const G4Step* aStep, bool /*was_used*/)
{
  ...
  if (!m_Detector->IsInsPHENIXMagnet(volume))
  {
    return false;
  }
...
//____________________________________________________________________________..
void PHG4sPHENIXMagnetSteppingAction::SetInterfacePointers(PHCompositeNode* topNode)
{
  string hitnodename;
  ...
  if (!m_HitContainer)
  {
    std::cout << "PHG4sPHENIXMagnetSteppingAction::SetTopNode - unable to find " << hitnodename << std::endl;
  }
}
