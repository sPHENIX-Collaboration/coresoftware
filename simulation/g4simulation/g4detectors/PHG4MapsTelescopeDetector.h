#ifndef PHG4MapsTelescopeDetector_h
#define PHG4MapsTelescopeDetector_h
...
class PHG4MapsTelescopeDetector: public PHG4Detector
{

  public:

  //! constructor
  PHG4MapsTelescopeDetector( PHCompositeNode *Node,  PHG4Parameters *parameters, const std::string &dnam="BLOCK" );

  //! destructor
  virtual ~PHG4MapsTelescopeDetector();
