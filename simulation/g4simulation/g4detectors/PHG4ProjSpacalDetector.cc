// $$Id: PHG4ProjSpacalDetector.cc,v 1.3 2015/02/10 15:39:26 pinkenbu Exp $$
...
PHG4ProjSpacalDetector::PHG4ProjSpacalDetector(PHCompositeNode *Node,
...
//_______________________________________________________________
void
PHG4ProjSpacalDetector::Construct(G4LogicalVolume* logicWorld)
{
  assert(_geom);

  if (_geom->get_construction_verbose() >= 1)
    {
      cout << "PHG4ProjSpacalDetector::Construct::" << GetName()
...
PHG4ProjSpacalDetector::Construct_AzimuthalSeg()
{
          ...
          if (abs(z_pivot_point) + dz_edge >= abs(z_lim))
            {
              ...
              cout << "PHG4ProjSpacalDetector::Construct_AzimuthalSeg::"
                  << GetName() << ": - "
  ...
  cout << "PHG4ProjSpacalDetector::Construct_AzimuthalSeg::" << GetName()
...
G4LogicalVolume*
PHG4ProjSpacalDetector::Construct_Block()
{
...
//  VisAtt->SetForceSolid((!_geom->is_azimuthal_seg_visible()));
  ...
  cout << "PHG4ProjSpacalDetector::Construct_Block::" << GetName()
...
void
PHG4ProjSpacalDetector::Print(const std::string &what) const
{
  cout << "PHG4ProjSpacalDetector::Print::" << GetName() << " - Print Geometry:"
      << endl;
  _geom->Print();
