...
class PHG4TpcGeomv2 : public PHG4TpcGeom
{
 public:
  PHG4TpcGeomv2() = default;

  ~PHG4TpcGeomv2() override = default;
  ...
  void set_rot_x(const double val) override { rot_x = val; }
  void set_rot_y(const double val) override { rot_y = val; }
  void set_rot_z(const double val) override { rot_z = val; }
  void set_place_x(const double val) override { place_x = val; }
  void set_place_y(const double val) override { place_y = val; }
  void set_place_z(const double val) override { place_z = val; }
 ...
 protected:
  ...
  double rot_x{std::numeric_limits<double>::quiet_NaN()};
  double rot_y{std::numeric_limits<double>::quiet_NaN()};
  double rot_z{std::numeric_limits<double>::quiet_NaN()};
  double place_x{std::numeric_limits<double>::quiet_NaN()};
  double place_y{std::numeric_limits<double>::quiet_NaN()};
  double place_z{std::numeric_limits<double>::quiet_NaN()};
  ...
  // streamer
  friend std::ostream& operator<<(std::ostream&, const PHG4TpcGeomv2&);

  ClassDefOverride(PHG4TpcGeomv2, 1)
};
