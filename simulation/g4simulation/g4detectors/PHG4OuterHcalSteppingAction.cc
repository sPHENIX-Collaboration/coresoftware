...
int PHG4OuterHcalSteppingAction::InitWithNode(PHCompositeNode* topNode)
{
  m_EnableFieldCheckerFlag = m_Params->get_int_param("field_check");
...
//____________________________________________________________________________..
bool PHG4OuterHcalSteppingAction::NoHitSteppingAction(const G4Step* aStep)
{
...
void PHG4OuterHcalSteppingAction::CreateNodeTree(PHCompositeNode* topNode)
{
