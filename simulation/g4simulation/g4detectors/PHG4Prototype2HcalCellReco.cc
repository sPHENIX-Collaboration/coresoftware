...
void
PHG4Prototype2HcalCellReco::cellsize(const int i, const double sr, const double sz)
{
  set_size(i, sr, sz, PHG4CylinderCellDefs::sizebinning);
}

void
PHG4Prototype2HcalCellReco::etaphisize(const int i, const double deltaeta, const double deltaphi)
{
...
void
PHG4Prototype2HcalCellReco::etasize_nslat(const int i, const double deltaeta, const int nslat)
{
  if (nslat >= 1)
    {
...
void
PHG4Prototype2HcalCellReco::set_size(const int i, const double sizeA, const int sizeB, const int what)
{
...
pair<double, double>
PHG4Prototype2HcalCellReco::get_etaphi(const double x, const double y, const double z)
{
  double eta;
  double phi;
  double radius;
...
double
PHG4Prototype2HcalCellReco::get_eta(const double radius, const double z)
{
  double eta;
  double theta;
...
double
PHG4Prototype2HcalCellReco::get_phi_slat_zero_low(const double radius, const double thickness, const double tiltangle)
{
...
double
PHG4Prototype2HcalCellReco::get_phi_slat_zero_up(const double radius, const double thickness, const double tiltangle)
{
  // A/sin(alpha) = C/sin(gamma)
  // beta = 90-gamma
