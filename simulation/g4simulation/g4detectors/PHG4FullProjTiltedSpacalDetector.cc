...
//_______________________________________________________________
void
PHG4FullProjTiltedSpacalDetector::Construct(G4LogicalVolume* logicWorld)
{
  assert(_geom);
...
//  PHG4Utils::SetColour(VisAtt, "W_Epoxy");
  ...
  if (_geom->get_config() == SpacalGeom_t::kFullProjective_2DTaper_Tilted)
    {
...
void
PHG4FullProjTiltedSpacalDetector::Print(const std::string &what) const
{
