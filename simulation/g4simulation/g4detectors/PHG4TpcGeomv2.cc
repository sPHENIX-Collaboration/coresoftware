...
namespace
{
  ...
  using array_t = std::array<std::vector<double>, PHG4TpcGeomv2::NSides>;
...
std::ostream& operator<<(std::ostream& out, const PHG4TpcGeomv2& geom)
{
  out << "PHG4TpcGeomv2 - layer: " << geom.layer << std::endl;
  out
      << "  binnig: " << geom.binning
      << ", radius: " << geom.radius
      << ", nzbins: " << geom.nzbins
...
void PHG4TpcGeomv2::set_zbins(const int i)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  nzbins = i;
}

void PHG4TpcGeomv2::set_zmin(const double z)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  zmin = z;
}

int PHG4TpcGeomv2::get_zbins() const
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  return nzbins;
}
...
double
PHG4TpcGeomv2::get_zstep() const
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  return zstep;
}

void PHG4TpcGeomv2::set_zstep(const double z)
{
  check_binning_method(PHG4CylinderCellDefs::sizebinning);
  zstep = z;
}

int PHG4TpcGeomv2::get_phibins() const
{
  check_binning_method_phi("PHG4TpcGeomv2::get_phibins");
  return nphibins;
}

double
PHG4TpcGeomv2::get_phistep() const
{
  check_binning_method_phi("PHG4TpcGeomv2::get_phistep");
  return phistep;
}

double
PHG4TpcGeomv2::get_phimin() const
{
  check_binning_method_phi("PHG4TpcGeomv2::get_phimin");
  return phimin;
}

void PHG4TpcGeomv2::set_phibins(const int i)
{
  check_binning_method_phi("PHG4TpcGeomv2::set_phibins");
  nphibins = i;
}

void PHG4TpcGeomv2::set_phistep(const double phi)
{
  check_binning_method_phi("PHG4TpcGeomv2::set_phistep");
  phistep = phi;
}

void PHG4TpcGeomv2::set_phimin(const double phi)
{
  check_binning_method_phi("PHG4TpcGeomv2::set_phimin");
  phimin = phi;
}

int PHG4TpcGeomv2::get_etabins() const
{
  check_binning_method_eta("PHG4TpcGeomv2::get_etabins");
  return nzbins;
}

double
PHG4TpcGeomv2::get_etastep() const
{
  check_binning_method_eta("PHG4TpcGeomv2::get_etastep");
  return zstep;
}
double
PHG4TpcGeomv2::get_etamin() const
{
  check_binning_method_eta("PHG4TpcGeomv2::get_etamin");
  return zmin;
}

void PHG4TpcGeomv2::set_etamin(const double z)
{
  check_binning_method_eta("PHG4TpcGeomv2::set_etamin");
  zmin = z;
}

void PHG4TpcGeomv2::set_etastep(const double z)
{
  check_binning_method_eta("PHG4TpcGeomv2::set_etastep");
  zstep = z;
}

void PHG4TpcGeomv2::set_etabins(const int i)
{
  check_binning_method_eta("PHG4TpcGeomv2::set_etabins");
  nzbins = i;
}

void PHG4TpcGeomv2::identify(std::ostream& os) const
{
  os << "PHG4TpcGeomv2::identify - layer: " << layer << std::endl;
  ...
  os << "  sector_R_bias: " << sector_R_bias << std::endl;
...
PHG4TpcGeomv2::get_etabounds(const int ibin) const
{
  ...
  check_binning_method_eta("PHG4TpcGeomv2::get_etabounds");
...
std::string
PHG4TpcGeomv2::methodname(const int i) const
{
  switch (i)
  {
...
void PHG4TpcGeomv2::check_binning_method(const int i) const
{
  if (binning != i)
  {
...
void PHG4TpcGeomv2::check_binning_method_eta(const std::string& src) const
{
...
void PHG4TpcGeomv2::check_binning_method_phi(const std::string& src) const
{
  if (binning != PHG4CylinderCellDefs::etaphibinning &&
