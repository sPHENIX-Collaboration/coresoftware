#ifndef PHG4HcalTestBeamSubsystem_h
#define PHG4HcalTestBeamSubsystem_h
...
class PHG4HcalTestBeamSteppingAction;
class PHG4EventAction;

class PHG4HcalTestBeamSubsystem: public PHG4Subsystem
{

  public:

  //! constructor
  PHG4HcalTestBeamSubsystem( const std::string &name = "BLOCK", const int layer = 0 );

  //! destructor
  virtual ~PHG4HcalTestBeamSubsystem( void )
  {}
  ...
  */
  ...
  PHG4HcalTestBeamSteppingAction* steppingAction_;
