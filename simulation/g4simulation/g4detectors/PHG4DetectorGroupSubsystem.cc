...
int PHG4DetectorGroupSubsystem::ReadParamsFromDB(const string &, const int)
{
  int iret = 1;
  // if (issuper)
  //   {
...
int PHG4DetectorGroupSubsystem::ReadParamsFromFile(const string &, const PHG4DetectorGroupSubsystem::FILE_TYPE ftyp, const int)
{
  string extension;
  switch (ftyp)
  {
