...
class PHG4Cell : public PHObject
{
 public:
  ...
  virtual void add_edep(const PHG4HitDefs::keytype, const float) { return; }
  virtual void add_edep(const PHG4HitDefs::keytype, const float, const float) { return; }
  virtual void add_edep(const PHG4HitDefs::keytype, const int, const float) { return; }
  // this adds showers to the shower map
  virtual void add_shower_edep(const int, const float) { return; }
  ...
  virtual bool has_property(const PROPERTY) const { return false; }
  virtual float get_property_float(const PROPERTY) const { return NAN; }
  virtual int get_property_int(const PROPERTY) const { return INT_MIN; }
  virtual unsigned int get_property_uint(const PROPERTY) const { return UINT_MAX; }
  virtual void set_property(const PROPERTY, const float) { return; }
  virtual void set_property(const PROPERTY, const int) { return; }
  virtual void set_property(const PROPERTY, const unsigned int) { return; }
 ...
 protected:
  PHG4Cell() {}
  virtual unsigned int get_property_nocheck(const PROPERTY) const { return UINT_MAX; }
  virtual void set_property_nocheck(const PROPERTY, const unsigned int) { return; }
