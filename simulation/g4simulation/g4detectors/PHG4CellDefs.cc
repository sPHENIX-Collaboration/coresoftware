...
PHG4CellDefs::keytype
PHG4CellDefs::MapsBinning::genkey(const unsigned short detid, const unsigned short zbin, const unsigned short iphi)
{
  PHG4CellDefs::keytype key = generic_16bit_genkey(detid, sizebinning, zbin, iphi);
  return key;
}
...
unsigned short int
PHG4CellDefs::MapsBinning::get_phibin(const PHG4CellDefs::keytype key)
{
...
unsigned short int
PHG4CellDefs::MapsBinning::get_zbin(const PHG4CellDefs::keytype key)
{
  unsigned short int zbin = generic_upper_16bit_key(key, sizebinning);
  return zbin;
}
