...
// from PHObject
  ...
  virtual void find_segment_center(const int, const int, double []){PHOOL_VIRTUAL_WARN("find_sensor_center"); return;}
  virtual void find_strip_center(const int, const int, const int, const int, double []){PHOOL_VIRTUAL_WARN("find_strip_center"); return;}
 virtual void find_strip_index_values(const int, const double, const double, int &, int &){PHOOL_VIRTUAL_WARN("find_strip_index_values"); return;}
  virtual void find_strip_center_local_coords(const int, const int, const int, double []){PHOOL_VIRTUAL_WARN("find_strip_center_localcoords"); return;}
  ...
  virtual void ImportParameters(const PHParameters &) {return ;}
