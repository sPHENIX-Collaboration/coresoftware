...
PHG4IHCalDisplayAction::PHG4IHCalDisplayAction(const std::string &name)
...
PHG4IHCalDisplayAction::~PHG4IHCalDisplayAction()
{
...
void PHG4IHCalDisplayAction::ApplyDisplayAction(G4VPhysicalVolume * /*physvol*/)
{
