...
//____________________________________________________________________________..
int PHG4IHCalSteppingAction::InitWithNode(PHCompositeNode* topNode)
{
...
//____________________________________________________________________________..
bool PHG4IHCalSteppingAction::NoHitSteppingAction(const G4Step* aStep)
{
...
void PHG4IHCalSteppingAction::CreateNodeTree(PHCompositeNode* topNode)
{
  ...
  PHIODataNode<PHObject>* towerNode = new PHIODataNode<PHObject>(m_CaloInfoContainer, "TOWERS_HCALIN", "PHObject");
