...
G4JLeicDIRCDetector::G4JLeicDIRCDetector(PHCompositeNode *Node, PHParameters *params, const std::string &dnam)
...
void G4JLeicDIRCDetector::Construct(G4LogicalVolume *logicWorld)
{
