...
G4JLeicBeamLineMagnetSteppingAction::G4JLeicBeamLineMagnetSteppingAction(G4JLeicBeamLineMagnetDetector* detector, const PHParameters* parameters)
...
G4JLeicBeamLineMagnetSteppingAction::~G4JLeicBeamLineMagnetSteppingAction()
{
...
//____________________________________________________________________________..
bool G4JLeicBeamLineMagnetSteppingAction::UserSteppingAction(const G4Step* aStep, bool was_used)
{
  ...
  int whichactive = m_Detector->IsInBeamLineMagnet(volume);
  if (!whichactive)
  {
    return false;
  }
