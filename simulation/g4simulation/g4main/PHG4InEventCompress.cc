...
int PHG4InEventCompress::InitRun(PHCompositeNode *topNode)
{
...
int PHG4InEventCompress::process_event(PHCompositeNode *topNode)
{
...
int PHG4InEventCompress::End(PHCompositeNode * /*topNode*/)
{
  return Fun4AllReturnCodes::EVENT_OK;
}
