...
PHG4EtaParameterization::PHG4EtaParameterization(
  ...
  _startPhi(startPhi), _deltaPhi(deltaPhi),
...
void
PHG4EtaParameterization::Print(std::ostream& os) const
{
...
void
PHG4EtaParameterization::ComputeTransformation(const G4int copyNo, G4VPhysicalVolume* physVol) const
{
  int iring = copyNo;
...
void
PHG4EtaParameterization::ComputeDimensions(G4Tubs& ring, const G4int copyNo, 
