...
class PHG4Shower : public PHObject
{
 public:
  ...
  virtual float get_covar(unsigned int, unsigned int) const { return NAN; }
  virtual void set_covar(unsigned int, unsigned int, float) {}

  virtual unsigned int get_nhits(int) const { return 0; }
  virtual void set_nhits(int, unsigned int) {}

  virtual double get_edep() const { return NAN; }
  virtual float get_edep(int) const { return NAN; }
  virtual void set_edep(int, float) {}

  virtual double get_eion() const { return NAN; }
  virtual float get_eion(int) const { return NAN; }
  virtual void set_eion(int, float) {}

  virtual float get_light_yield(int) const { return NAN; }
  virtual void set_light_yield(int, float) {}

  virtual float get_eh_ratio(int) const { return NAN; }
  ...
  virtual size_t remove_g4particle_id(int) { return 0; }
  ...
  virtual size_t remove_g4vertex_id(int) { return 0; }
