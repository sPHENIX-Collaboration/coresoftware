...
PHG4InEventReadBack::PHG4InEventReadBack(const std::string &name)
  : SubsysReco(name)
{
}

int PHG4InEventReadBack::InitRun(PHCompositeNode *topNode)
{
...
int PHG4InEventReadBack::process_event(PHCompositeNode *topNode)
{
...
int PHG4InEventReadBack::End(PHCompositeNode * /*topNode*/)
{
  return Fun4AllReturnCodes::EVENT_OK;
}
