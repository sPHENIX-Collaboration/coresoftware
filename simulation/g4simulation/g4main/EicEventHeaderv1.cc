...
void
EicEventHeaderv1::Reset()
{
  prop_map.clear();
}

bool
EicEventHeaderv1::has_property(const PROPERTY prop_id) const
{
...
float
EicEventHeaderv1::get_property_float(const PROPERTY prop_id) const
{
...
int
EicEventHeaderv1::get_property_int(const PROPERTY prop_id) const
{
...
void
EicEventHeaderv1::set_property(const PROPERTY prop_id, const float value)
{
  if (!check_property(prop_id,type_float))
    {
      pair<const string,PROPERTY_TYPE> property_info = get_property_info(prop_id); 
...
void
EicEventHeaderv1::set_property(const PROPERTY prop_id, const int value)
{
  if (!check_property(prop_id,type_int))
    {
      pair<const string,PROPERTY_TYPE> property_info = get_property_info(prop_id); 
...
void
EicEventHeaderv1::set_property(const PROPERTY prop_id, const unsigned int value)
{
  if (!check_property(prop_id,type_uint))
    {
      pair<const string,PROPERTY_TYPE> property_info = get_property_info(prop_id); 
