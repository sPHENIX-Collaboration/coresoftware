...
void PHG4PhenixTrackingAction::PreUserTrackingAction(const G4Track* track)
{
  if (Verbosity() > 0)
  {
    std::cout << "PHG4PhenixTrackingAction::PreUserTrackingAction" << std::endl;
  }
  ...
  for (ActionList::const_iterator iter = actions_.begin(); iter != actions_.end(); ++iter)
  {
    if (*iter)
    {
      if (Verbosity() > 0)
      {
        std::cout << "PHG4PhenixTrackingAction::PreUserTrackingAction - processing " << *iter << std::endl;
      }
...
void PHG4PhenixTrackingAction::PostUserTrackingAction(const G4Track* track)
{
  if (Verbosity() > 0)
  {
    std::cout << "PHG4PhenixTrackingAction::PostUserTrackingAction" << std::endl;
  }
  ...
  for (ActionList::const_iterator iter = actions_.begin(); iter != actions_.end(); ++iter)
  {
    if (*iter)
    {
      if (Verbosity() > 0)
      {
        std::cout << "PHG4PhenixTrackingAction::PostUserTrackingAction - processing " << *iter << std::endl;
      }
