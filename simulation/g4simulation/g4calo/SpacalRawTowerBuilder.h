#ifndef SpacalRawTowerBuilder_H__
#define SpacalRawTowerBuilder_H__
...
class SpacalRawTowerBuilder : public SubsysReco {

 public:
  SpacalRawTowerBuilder(const std::string& name="SpacalRawTowerBuilder");
  virtual ~SpacalRawTowerBuilder(){}
...
#endif /* SpacalRawTowerBuilder_H__ */
