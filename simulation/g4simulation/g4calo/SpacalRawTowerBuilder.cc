...
int
SpacalRawTowerBuilder::InitRun(PHCompositeNode *topNode)
{
  ...
  if (!cellgeos)
    {
      ...
      throw std::runtime_error(
			       ...
			       + " node in SpacalRawTowerBuilder::CreateNodes");
    }
...
int
SpacalRawTowerBuilder::process_event(PHCompositeNode *topNode)
{
  if (verbosity)
    {
...
void
SpacalRawTowerBuilder::CreateNodes(PHCompositeNode *topNode)
{
  ...
  for (miter = begin_end.first; miter != begin_end.second; ++miter)
      ...
      if (ifirst)
	{
	  ...
	  if (_cell_binning == PHG4CellDefs::etaphibinning
	    ...
	    {
	      cout << "SpacalRawTowerBuilder::CreateNodes::" << Name()
  ...
  if (_cell_binning == PHG4CellDefs::etaphibinning
    ...
    {
      cout << "SpacalRawTowerBuilder::CreateNodes - ERROR - unsupported cell geometry "
	   << _cell_binning << endl;
      exit(1);
    }
