...
class RawTower : public PHObject {
 ...
 public:
  ...
  virtual double get_tower_type() const { PHOOL_VIRTUAL_WARN("get_tower_type()"); return -1.0; }
  virtual void set_tower_type (const double ) { PHOOL_VIRTUAL_WARN("set_tower_type()"); return  ; }
