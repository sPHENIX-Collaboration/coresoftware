...
void TPCDetector::BuildCage(G4LogicalVolume* tpcWorld)
{
  ...
  G4Material *mat_fr4 = mat_cu;//nist->FindOrBuildMaterial("TPC_FR4");
  G4Material *mat_hco = mat_cu;//nist->FindOrBuildMaterial("TPC_HONEYCOMB");
  G4Material *mat_kap = mat_cu;//nist->FindOrBuildMaterial("TPC_KAPTON");
