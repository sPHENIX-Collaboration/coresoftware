...
int JetEvaluator::Init(PHCompositeNode *)
{
  _ievent = 0;
...
int JetEvaluator::End(PHCompositeNode *)
{
  _tfile->cd();
...
void JetEvaluator::printInputInfo(PHCompositeNode *)
{
  // to be implemented later if needed
  return;
}

void JetEvaluator::printOutputInfo(PHCompositeNode *)
{
  // to be implemented later if needed
  return;
}
