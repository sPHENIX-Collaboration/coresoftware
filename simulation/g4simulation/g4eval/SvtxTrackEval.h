...
public:
  ...
  unsigned int get_nmaps_contribution(SvtxTrack* svtxtrack, PHG4Particle* truthparticle);  
  unsigned int get_ntpc_contribution(SvtxTrack* svtxtrack, PHG4Particle* truthparticle);  
