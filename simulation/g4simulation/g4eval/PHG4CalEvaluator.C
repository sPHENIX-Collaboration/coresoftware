...
PHG4CalEvaluator::PHG4CalEvaluator(const string &name, const string &filename) :
...
int PHG4CalEvaluator::Init(PHCompositeNode *topNode)
{
  _ievent = 0;
...
int PHG4CalEvaluator::process_event(PHCompositeNode *topNode)
{
  // pull the g4 truth
...
int PHG4CalEvaluator::End(PHCompositeNode *topNode)
{
  _tfile->cd();
...
void PHG4CalEvaluator::fillGshowerObjects()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::fillGshowerObjects() entered" << endl;
  ...
  for (hiter = hit_begin_end.first; hiter != hit_begin_end.second; hiter++)
    {
      ...
      if(!particle)
	{
	  cout << "PHG4CalEvaluator::fillGshowerObjects() - ERROR, Corrupt truth information, skip hit!" << endl;
...
void PHG4CalEvaluator::printInputInfo()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::printInputInfo() entered" << endl;
...
void PHG4CalEvaluator::printOutputInfo()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::printOutputInfo() entered" << endl;
...
void PHG4CalEvaluator::fillTowerToGshowerMap()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::fillTowerToGshowerMap() entered" << endl;
...
void PHG4CalEvaluator::fillClusterToGshowerMap()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::fillClusterToGshowerMap() entered" << endl;
...
void PHG4CalEvaluator::fillOutputNtuples()
{
  if(verbosity > 1) cout << "PHG4CalEvaluator::fillOutputNtuples() entered" << endl;
  ...
  if(verbosity > 1) cout << "PHG4CalEvaluator::filling gshower ntuple..." << endl;
  ...
  if(verbosity > 1) cout << "PHG4CalEvaluator::filling tower ntuple..." << endl;
  ...
  if(verbosity > 1) cout << "PHG4CalEvaluator::filling gcluster ntuple..." << endl;
