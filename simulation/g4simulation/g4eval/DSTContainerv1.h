...
#ifndef G4EVAL_DSTCONTAINERV1_H
#define G4EVAL_DSTCONTAINERV1_H

/*!
 * \file DSTContainerv1.h
...
*/
class DSTContainerv1: public DSTContainer
{

  public:

  //! constructor
  explicit DSTContainerv1()
  {
  ...
  class ClusterStruct
  {
    ...
    ClusterStruct(TrkrDefs::cluskey key, TrkrCluster* cluster)
    {
      clusterKey = key;
  ...
  ClassDefOverride(DSTContainerv1,1)
