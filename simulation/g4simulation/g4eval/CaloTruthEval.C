...
PHG4Hit* CaloTruthEval::get_innermost_truth_hit(PHG4Particle* particle) {
...
PHG4Hit* CaloTruthEval::get_outermost_truth_hit(PHG4Particle* particle) {

  PHG4Hit* outermost_hit = NULL;
  float outermost_radius = FLT_MIN;
...
PHG4Particle* CaloTruthEval::get_particle(PHG4Hit* g4hit) {
