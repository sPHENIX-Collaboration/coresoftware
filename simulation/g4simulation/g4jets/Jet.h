...
class Jet : public PHObject
{
 public:
  ...
  virtual float get_property(Jet::PROPERTY) const { return NAN; }
  virtual void set_property(Jet::PROPERTY, float) { return; }
  virtual void print_property(std::ostream&) const { return; }
  ...
  virtual size_t count_comp(Jet::SRC) const { return 0; }

  virtual void clear_comp() { return; }
  virtual void insert_comp(Jet::SRC, unsigned int) { return; }
  virtual size_t erase_comp(Jet::SRC) { return 0; }
  virtual void erase_comp(Iter) { return; }
