...
class JetMap : public PHObject
{
 public:
  ...
  virtual void set_algo(Jet::ALGO) { return; }
  ...
  virtual void insert_src(Jet::SRC) { return; }
  ...
  virtual const Jet* get(unsigned int) const { return nullptr; }
  virtual Jet* get(unsigned int) { return nullptr; }

  virtual Jet* insert(Jet*) { return nullptr; }
