...
JetMap::ConstSrcIter JetMap::find_src(Jet::SRC) const
{
  return DummyJetSourceSet.end();
}
...
JetMap::SrcIter JetMap::find_src(Jet::SRC)
{
  return DummyJetSourceSet.end();
}
...
JetMap::ConstIter JetMap::find(unsigned int) const
{
  return DummyJetMapMap.end();
}
...
JetMap::Iter JetMap::find(unsigned int)
{
  return DummyJetMapMap.end();
}
