...
void
JetV1::print_property(ostream& os) const
{
...
bool
JetV1::has_property(JetV1::PROPERTY prop_id) const
{
  typ_property_map::const_iterator
  citer = _property_map.find(prop_id);
...
float
JetV1::get_property(JetV1::PROPERTY prop_id) const
{
  typ_property_map::const_iterator
  citer = _property_map.find(prop_id);
...
void
JetV1::set_property(PROPERTY prop_id, float value)
{
