...
int
G4HitNtuple::Init( PHCompositeNode* )
{
...
int
G4HitNtuple::process_event( PHCompositeNode* topNode )
{
...
int
G4HitNtuple::End(PHCompositeNode * topNode)
{
  outfile->cd();
  ntup->Write();
  outfile->Write();
...
void
G4HitNtuple::AddNode(const std::string &name, const int detid)
{
