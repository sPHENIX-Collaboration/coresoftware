...
int
G4EdepNtuple::Init( PHCompositeNode* )
{
...
int
G4EdepNtuple::process_event( PHCompositeNode* topNode )
{
...
int
G4EdepNtuple::End(PHCompositeNode * topNode)
{
  outfile->cd();
  ntup->Write();
  outfile->Write();
...
void
G4EdepNtuple::AddNode(const std::string &name, const int detid)
{
