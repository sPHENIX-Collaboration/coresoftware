...
int
G4CellNtuple::Init( PHCompositeNode* )
{
...
int
G4CellNtuple::process_event( PHCompositeNode* topNode )
{
...
int
G4CellNtuple::End(PHCompositeNode * topNode)
{
  outfile->cd();
  ntup->Write();
  outfile->Write();
...
void
G4CellNtuple::AddNode(const std::string &name, const int detid)
{
