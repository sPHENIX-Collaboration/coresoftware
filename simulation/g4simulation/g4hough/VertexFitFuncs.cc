...
VertexFitFuncs::VertexFitFuncs() : FunctionGradHessian(3,1)
{
  
}


VertexFitFuncs::~VertexFitFuncs()
{
  
}


bool VertexFitFuncs::calcValGradHessian(const VectorXd& x, double& val, VectorXd& grad, MatrixXd& hessian)
{
