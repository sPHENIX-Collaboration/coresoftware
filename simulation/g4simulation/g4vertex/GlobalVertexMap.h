...
class GlobalVertexMap : public PHObject
{
 public:
  ...
  virtual const GlobalVertex* get(unsigned int) const { return nullptr; }
  virtual GlobalVertex* get(unsigned int) { return nullptr; }
  virtual GlobalVertex* insert(GlobalVertex*) { return nullptr; }
