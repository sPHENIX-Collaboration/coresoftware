...
// ********************************************************************
//
// $Id: EvtGenExtDecayerPhysics.cc,v 1.3 2015/01/05 23:49:39 mccumber Exp $
//
/// \file eventgenerator/pythia/decayer6/src/EvtGenExtDecayerPhysics.cc
...
void EvtGenExtDecayerPhysics::ConstructProcess()
{
  ...
  std::cout << "EvtGenExtDecayerPhysics Now Bro" << std::endl;
  ...
  while ((*aParticleIterator)())
  {
	...
	if( abs(particle->GetPDGEncoding()) > 400 && abs(particle->GetPDGEncoding()) < 600 )  std::cout << "Particle: " << particle->GetParticleName() << "  (PDGID: " << particle->GetPDGEncoding()  << " )   is inside the GEANT 4 Decay Table"   << std::endl;
