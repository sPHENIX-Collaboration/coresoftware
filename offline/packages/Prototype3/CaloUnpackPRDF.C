...
int CaloUnpackPRDF::process_event(PHCompositeNode *topNode)
{
 ...
 _packet = dynamic_cast<Packet_hbd_fpgashort*>(_event->getPacket(PROTOTYPE3_FEM::PACKET_ID));
 ...
 for(int ibinz=0; ibinz<PROTOTYPE3_FEM::NCH_IHCAL_ROWS; ibinz++)
 {
  ...
  {
   tower_lg = dynamic_cast<RawTower_Prototype3*>(hcalin_towers_lg->getTower(ibinz,ibinphi));
   if(!tower_lg)
   {
   ...
   tower_hg = dynamic_cast<RawTower_Prototype3*>(hcalin_towers_hg->getTower(ibinz,ibinphi));
   if(!tower_hg)
   {
 ...
 for(int ibinz=0; ibinz<PROTOTYPE3_FEM::NCH_OHCAL_ROWS; ibinz++)
 {
  ...
  {
      tower_lg = dynamic_cast<RawTower_Prototype3*>(hcalout_towers_lg->getTower(ibinz,ibinphi));
      if(!tower_lg)
      {
          tower_lg = new RawTower_Prototype3();
          tower_lg->set_energy(NAN);
      ...
      tower_hg = dynamic_cast<RawTower_Prototype3*>(hcalout_towers_hg->getTower(ibinz,ibinphi));
      if(!tower_hg)
      {
          tower_hg = new RawTower_Prototype3();
          tower_hg->set_energy(NAN);
 ...
 for(int ibinz=0; ibinz<PROTOTYPE3_FEM::NCH_EMCAL_ROWS; ibinz++)
 {
  ...
  {
   tower = dynamic_cast<RawTower_Prototype3*>(emcal_towers->getTower(ibinz,ibinphi));
   if(!tower)
   {
 ...
 if(verbosity)
 {
   ...
   {
    RawTower_Prototype3 *tower = dynamic_cast<RawTower_Prototype3*>(iter->second);
    tower->identify();
