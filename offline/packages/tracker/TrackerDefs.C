...
char
TrackerDefs::get_detid(const TrackerDefs::keytype key)
{
...
char
TrackerDefs::get_layer(const TrackerDefs::keytype key)
{
...
char
TrackerDefs::get_ladder(const TrackerDefs::keytype key)
{
...
char
TrackerDefs::get_chip(const TrackerDefs::keytype key)
{
