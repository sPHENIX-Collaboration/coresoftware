...
class MapToPadPlanePassData: public PHObject
{
  public:
    ...
    MapToPadPlanePassData( unsigned int _layer, int _neff_electrons, double _phi_integral, double _time_integral,
    ...
    MapToPadPlanePassData() :
      layer {0}, neff_electrons {0}, phi_integral {0.}, time_integral {0.},
