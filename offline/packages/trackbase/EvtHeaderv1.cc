...
void 
EvtHeaderv1::identify(std::ostream& os)
{
...
EvtHeaderv1::GetBCO(TrkrDefs::TrkrId const& trkr_id, FEE_t const& fee, BCO_t const& bco) const
{
  return bco_map.find(std::make_pair(trk_id, fee));
}
