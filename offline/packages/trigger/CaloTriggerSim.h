...
class CaloTriggerSim : public SubsysReco
{
 ...
 private:
  ...
  std::vector<double>::size_type m_EMCAL_2x2_NETA{std::numeric_limits<std::vector<double>::size_type>::max()};
  std::vector<double>::size_type m_EMCAL_2x2_NPHI{std::numeric_limits<std::vector<double>::size_type>::max()};
  ...
  std::vector<double>::size_type m_FULLCALO_0p2x0p2_NETA{std::numeric_limits<std::vector<double>::size_type>::max()};
  std::vector<double>::size_type m_FULLCALO_0p2x0p2_NPHI{std::numeric_limits<std::vector<double>::size_type>::max()};
