...
class Eventplaneinfo : public PHObject
{
 public:
  ...
  virtual std::pair<double, double> get_qvector_raw(int /*order*/) const { return std::make_pair(NAN, NAN); }
  virtual std::pair<double, double> get_qvector_recentered(int /*order*/) const { return std::make_pair(NAN, NAN); }
