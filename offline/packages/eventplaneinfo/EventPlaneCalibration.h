...
class EventPlaneCalibration : public SubsysReco {
public:
  EventPlaneCalibration(const std::string &name = "EventPlaneCalibration");
  ~EventPlaneCalibration() override = default;
  ...
  void set_default_calibfile(bool default_calib) {
    _default_calib = default_calib;
  }
  ...
  void set_outfilename(const std::string &name) {OutFileName = name;}
