...
double TpcClusterZCrossingCorrection::_vdrift = 8.0e-03;

// ns, same value as in pileup generator
double TpcClusterZCrossingCorrection::_time_between_crossings = sphenix_constants::time_between_crossings;

//______________________________________________________________________________________________
double TpcClusterZCrossingCorrection::correctZ(double zinit, unsigned int side, short int crossing)
{
  ...
  double z_bunch_separation = _time_between_crossings * _vdrift;
