...
void KFParticle_truthAndDetTools::fillTruthBranch(PHCompositeNode *topNode, TTree *, KFParticle daughter, int daughter_id, KFParticle vertex, bool m_constrain_to_vertex_truthMatch)
{
...
int KFParticle_truthAndDetTools::getHepMCInfo(PHCompositeNode *topNode, TTree *, KFParticle daughter, int daughter_id)
{
...
void KFParticle_truthAndDetTools::fillCaloBranch(PHCompositeNode *topNode,
                                                 TTree *, KFParticle daughter, int daughter_id)
{
  PHNodeIterator nodeIter(topNode);
  PHNode *findNode = dynamic_cast<PHNode*>(nodeIter.findFirst(m_trk_map_node_name_nTuple));
  if (findNode)
