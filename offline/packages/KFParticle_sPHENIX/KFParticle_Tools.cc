...
KFParticle KFParticle_Tools::makeVertex(PHCompositeNode *)
{
...
KFParticle KFParticle_Tools::makeParticle(PHCompositeNode *)  ///Return a KFPTrack from track vector and covariance matrix. No mass or vertex constraints
{
...
bool KFParticle_Tools::isGoodTrack(KFParticle particle, const std::vector<KFParticle> primaryVertices)
{
