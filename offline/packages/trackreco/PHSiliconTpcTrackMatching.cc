...
int  PHSiliconTpcTrackMatching::GetNodes(PHCompositeNode* topNode)
{
  ...
  if(!_svtx_seed_map)
  {
    ...
    auto node = new PHIODataNode<PHObject>(_svtx_seed_map, "SvtxTrackSeedContainer","PHObject");
...
Acts::Vector3 PHSiliconTpcTrackMatching::getGlobalPosition( TrkrDefs::cluskey key, TrkrCluster* cluster ) const
{
