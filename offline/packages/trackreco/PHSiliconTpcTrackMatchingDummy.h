...
//  -*- C++ -*-.
#ifndef PHSILICONTPCTRACKMATCHINGDUMMY_H
#define PHSILICONTPCTRACKMATCHINGDUMMY_H
...
class PHSiliconTpcTrackMatchingDummy : public SubsysReco, public PHParameterInterface
{
 public:
  PHSiliconTpcTrackMatchingDummy(const std::string &name = "PHSiliconTpcTrackMatchingDummy");

  ~PHSiliconTpcTrackMatchingDummy() override;
  ...
  struct WindowMatcher {
    ...
    // efficiency flags set during PHSiliconTpcTrackMatchingDummy::InitRun()
...
#endif  //  PHSILICONTPCTRACKMATCHINGDUMMY_H
