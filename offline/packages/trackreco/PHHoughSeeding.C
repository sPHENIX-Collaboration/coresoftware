...
int PHHoughSeeding::check_track_exists(MapPHGenFitTrack::iterator iter){
...
int PHHoughSeeding::KalmanTrkProp() {

#ifdef _DEBUG_
	std::cout << "=========================" << std::endl;
	std::cout << "PHHoughSeeding::KalmanTrkProp: Start: Event: "<< _event << std::endl;
...
#ifdef _DEBUG_
	std::cout << "=========================" << std::endl;
	std::cout << "PHHoughSeeding::KalmanTrkProp: End: Event: "<< _event << std::endl;
...
int PHHoughSeeding::OutputPHGenFitTrack(MapPHGenFitTrack::iterator iter) {
...
int PHHoughSeeding::SimpleTrack3DToPHGenFitTracks(unsigned int itrack) {
