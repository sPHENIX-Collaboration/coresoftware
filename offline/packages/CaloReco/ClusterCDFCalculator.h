...
private:
    ...
    std::vector<TH1*> hD2_3x3;
    std::vector<TH1*> hD2_5x5;
    std::vector<TH1*> hD2_7x7;
    ...
    std::vector<std::vector<TH1*>> ratioHistograms_3x3;
    std::vector<std::vector<TH1*>> ratioHistograms_5x5;
    std::vector<std::vector<TH1*>> ratioHistograms_7x7;
