                                     ...
                                     ActsGeometry* geometry)
{
                    ...
                    TrkrDefs::TrkrId::tpcId, TrkrDefs::TrkrId::micromegasId})
  {
	...
	m_overlap = static_cast<int>(cluster->getOverlap());
	m_nedge = static_cast<int>(cluster->getEdge());
	m_sledge = static_cast<int>(cluster->getSLEdge());
	m_sredge = static_cast<int>(cluster->getSREdge());
	m_tledge = static_cast<int>(cluster->getTLEdge());
	m_tredge = static_cast<int>(cluster->getTREdge());
	m_dledge = static_cast<int>(cluster->getDLEdge());
	m_dredge = static_cast<int>(cluster->getDREdge());
	m_hledge = static_cast<int>(cluster->getHLEdge());
	m_hredge = static_cast<int>(cluster->getHREdge());
...
void TrackResiduals::createBranches()
{
  ...
  m_clustree->Branch("overlap", &m_overlap, "m_overlap/I");
  m_clustree->Branch("nedge", &m_nedge, "m_nedge/I");
  m_clustree->Branch("sledge", &m_sledge, "m_sledge/I");
  m_clustree->Branch("sredge", &m_sredge, "m_sredge/I");
  m_clustree->Branch("tledge", &m_tledge, "m_tledge/I");
  m_clustree->Branch("tredge", &m_tredge, "m_tredge/I");
  m_clustree->Branch("dledge", &m_dledge, "m_dledge/I");
  m_clustree->Branch("dredge", &m_dredge, "m_dredge/I");
  m_clustree->Branch("hledge", &m_hledge, "m_hledge/I");
  m_clustree->Branch("hredge", &m_hredge, "m_hredge/I");
