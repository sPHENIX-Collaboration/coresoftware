...
enum n_info  {infonocc11, infonocc116, infonocc21, infonocc216, infonocc31, infonocc316,infonhitmvtx,infontrk,
	      infonhitintt,
	      infonhittpot,
	      infonhittpcall,
	      infonhittpcin,
...
enum n_residual  {nresphi,nresz,ressize = nresz+1};

enum n_track  {ntrktrackID,
	       ntrkcrossing,
	       ntrkpx,
	       ntrkpy,
	       ntrkpz,
