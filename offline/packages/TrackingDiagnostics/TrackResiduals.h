...
class TrackResiduals : public SubsysReco
{
 ...
 private:
  ...
  int m_overlap = std::numeric_limits<int>::quiet_NaN();
  int m_nedge = std::numeric_limits<int>::quiet_NaN();
  int m_sledge = std::numeric_limits<int>::quiet_NaN();
  int m_sredge = std::numeric_limits<int>::quiet_NaN();
  int m_tledge = std::numeric_limits<int>::quiet_NaN();
  int m_tredge = std::numeric_limits<int>::quiet_NaN();
  int m_dledge = std::numeric_limits<int>::quiet_NaN();
  int m_dredge = std::numeric_limits<int>::quiet_NaN();
  int m_hledge = std::numeric_limits<int>::quiet_NaN();
  int m_hredge = std::numeric_limits<int>::quiet_NaN();
