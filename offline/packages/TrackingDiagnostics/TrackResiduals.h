...
class TrackResiduals : public SubsysReco
{
 ...
 private:
  ...
  char m_overlap = std::numeric_limits<int>::quiet_NaN();
  char m_nedge = std::numeric_limits<int>::quiet_NaN();
  char m_sledge = std::numeric_limits<int>::quiet_NaN();
  char m_sredge = std::numeric_limits<int>::quiet_NaN();
  char m_tledge = std::numeric_limits<int>::quiet_NaN();
  char m_tredge = std::numeric_limits<int>::quiet_NaN();
  char m_dledge = std::numeric_limits<int>::quiet_NaN();
  char m_dredge = std::numeric_limits<int>::quiet_NaN();
  char m_hledge = std::numeric_limits<int>::quiet_NaN();
  char m_hredge = std::numeric_limits<int>::quiet_NaN();
  int m_slmix = std::numeric_limits<int>::quiet_NaN();
  int m_srmix = std::numeric_limits<int>::quiet_NaN();
  int m_tlmix = std::numeric_limits<int>::quiet_NaN();
  int m_trmix = std::numeric_limits<int>::quiet_NaN();
