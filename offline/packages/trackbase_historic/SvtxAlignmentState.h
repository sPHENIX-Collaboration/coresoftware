...
class SvtxAlignmentState : public PHObject
{
 public:
  ...
  typedef Eigen::Matrix<double, NLOC, NLOC> LocalMatrixPsuedo;
  ...
  virtual void set_local_psuedo_measurement_err(const ActsTrackParamsVector&) {}
  ...
  virtual const ActsTrackParamsVector& get_local_psuedo_measurement_err() const;
