...
class SvtxTrackMap : public PHObject
{
 public:
  ...
  virtual const SvtxTrack* get(unsigned int) const { return nullptr; }
  virtual SvtxTrack* get(unsigned int) { return nullptr; }
  virtual SvtxTrack* insert(const SvtxTrack*) { return nullptr; }
