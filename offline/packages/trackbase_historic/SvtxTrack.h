...
class SvtxTrack : public PHObject
{
 public:
  ...
  virtual float get_error(int, int) const { return NAN; }
  ...
  virtual const SvtxTrackState* get_state(float) const { return nullptr; }
  virtual SvtxTrackState* get_state(float) { return nullptr; }
  virtual SvtxTrackState* insert_state(const SvtxTrackState*) { return nullptr; }
  virtual size_t erase_state(float) { return 0; }
  ...
  //! deprecated - please use cluster keys instead
  virtual size_t erase_cluster(unsigned int) { return 0; }
  //! deprecated - please use cluster keys instead
  ...
  //
  virtual float get_cal_dphi(CAL_LAYER) const { return 0.; }
  virtual void set_cal_dphi(CAL_LAYER, float) {}

  virtual float get_cal_deta(CAL_LAYER) const { return 0.; }
  virtual void set_cal_deta(CAL_LAYER, float) {}

  virtual float get_cal_energy_3x3(CAL_LAYER) const { return 0.; }
  virtual void set_cal_energy_3x3(CAL_LAYER, float) {}

  virtual float get_cal_energy_5x5(CAL_LAYER) const { return 0.; }
  virtual void set_cal_energy_5x5(CAL_LAYER, float) {}

  virtual unsigned int get_cal_cluster_id(CAL_LAYER) const { return 0; }
  virtual void set_cal_cluster_id(CAL_LAYER, unsigned int) {}

  virtual TrkrDefs::cluskey get_cal_cluster_key(CAL_LAYER) const { return 0; }
  virtual void set_cal_cluster_key(CAL_LAYER, TrkrDefs::cluskey) {}

  virtual float get_cal_cluster_e(CAL_LAYER) const { return 0.; }
  virtual void set_cal_cluster_e(CAL_LAYER, float) {}

  // Acts methods for use by Acts modules only
  virtual float get_acts_covariance(unsigned int, unsigned int) const { return NAN;}
