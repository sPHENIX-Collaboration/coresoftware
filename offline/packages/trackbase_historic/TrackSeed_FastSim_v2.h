#ifndef TRACKBASEHISTORIC_TRACKSEED_FASTSIM_V2_H
#define TRACKBASEHISTORIC_TRACKSEED_FASTSIM_V2_H

#include "TrackSeed_v2.h"

class TrackSeed_FastSim_v2 : public TrackSeed_v2
{
 public:
  TrackSeed_FastSim_v2() = default;
  TrackSeed_FastSim_v2(const TrackSeed&);
  ~TrackSeed_FastSim_v2() = default;

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = TrackSeed_FastSim_v2(); }
  int isValid() const override { return 1; }
  void CopyFrom(const TrackSeed&) override;
  void CopyFrom(TrackSeed* seed) override { CopyFrom(*seed); }

  PHObject* CloneMe() const override { return new TrackSeed_FastSim_v2(*this); }
 ...
 private:
  ...
  ClassDefOverride(TrackSeed_FastSim_v2, 1)
};
