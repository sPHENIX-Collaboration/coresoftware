/*
 * SvtxTrack_FastSim_v3.C
 *
 *  Created on: Jul 28, 2016
 *      Author: yuhw
 */

#include "SvtxTrack_FastSim_v3.h"
...
SvtxTrack_FastSim_v3::SvtxTrack_FastSim_v3(const SvtxTrack& source)
{ SvtxTrack_FastSim_v3::CopyFrom( source ); }
...
void SvtxTrack_FastSim_v3::identify(std::ostream& os) const
{
  SvtxTrack_v3::identify(os);

  os << "SvtxTrack_FastSim_v3 Object ";
...
int SvtxTrack_FastSim_v3::isValid() const
{
  return 1;
}
