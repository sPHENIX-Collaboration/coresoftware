...
SvtxTrack::ConstStateIter SvtxTrack::find_state(float)  const
{
  return DummyStateMap.end();
}
...
SvtxTrack::StateIter SvtxTrack::find_state(float)
{
return DummyStateMap.end();
}
...
SvtxTrack::ClusterIter SvtxTrack::find_cluster(unsigned int)
{
  return DummyClusterSet.end();
}
...
SvtxTrack::ConstClusterKeyIter SvtxTrack::find_cluster_key(TrkrDefs::cluskey) const
{
...
SvtxTrack::ClusterKeyIter SvtxTrack::find_cluster_keys(unsigned int)
{
  return DummyClusterKeySet.end();
}
