...
#ifndef TRACKBASEHISTORIC_SVTXTRACKFASTSIMV3_H
#define TRACKBASEHISTORIC_SVTXTRACKFASTSIMV3_H

#include "SvtxTrack_v3.h"

// SvtxTrack_FastSim with recording of associated G4hits
class SvtxTrack_FastSim_v3 final: public SvtxTrack_v3
{
 public:

  //* constructor
  SvtxTrack_FastSim_v3() = default;

  //* base class copy constructor
  SvtxTrack_FastSim_v3( const SvtxTrack& );

  //* destructor
  ~SvtxTrack_FastSim_v3() override = default;
  ...
  void Reset()  override{ *this = SvtxTrack_FastSim_v3(); }
  int isValid() const override;

  PHObject* CloneMe() const override
  { return new SvtxTrack_FastSim_v3(*this); }
 ...
 private:
  ...
  ClassDefOverride(SvtxTrack_FastSim_v3, 1)
};

#endif /* __SVTXTRACK_FAST_SIMV3_H__ */
