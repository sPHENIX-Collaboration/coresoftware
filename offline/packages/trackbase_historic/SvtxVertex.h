...
class SvtxVertex : public PHObject
{
 public:
  ...
  virtual float get_error(unsigned int, unsigned int) const { return NAN; }
  ...
  virtual size_t erase_track(unsigned int) { return 0; }
  virtual ConstTrackIter begin_tracks() const;
  virtual ConstTrackIter find_track(unsigned int) const;
  virtual ConstTrackIter end_tracks() const;
  virtual TrackIter begin_tracks();
  virtual TrackIter find_track(unsigned int);
