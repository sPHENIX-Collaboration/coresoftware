...
)
{
    ...
    if (event_i%1000 == 0 && print_message_opt == true) {std::cout<<"In INTTZvtx class, running event : "<<event_i<<std::endl;}
...
double INTTZvtx::LB_geo_mean(TH1 * hist_in, std::pair<double, double> search_range, int /*event_i*/)
{
    ...
    std::vector<float> same_height_bin; same_height_bin.clear(); same_height_bin.push_back(Highest_bin_center);
