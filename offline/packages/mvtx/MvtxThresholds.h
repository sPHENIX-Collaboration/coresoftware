...
class MvtxThresholds : public SubsysReco
{
 public:

  MvtxThresholds(const std::string &name = "MvtxThresholds");

  virtual ~MvtxThresholds(){}
  ...
  void set_threshold(const float fraction_of_mip) {
    std::cout << "MvtxThresholds use is out of date. "
