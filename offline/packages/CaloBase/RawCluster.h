...
class RawCluster : public PHObject
{
 public:
  ...
  void identify(std::ostream&) const override { PHOOL_VIRTUAL_WARNING; }
  /** @defgroup getters
   *  @{
   */
  //! cluster ID
  ...
  */
  ...
  //! Tower operations
  virtual void addTower(const RawClusterDefs::keytype, const float) { PHOOL_VIRTUAL_WARNING; }
  //! total energy
  ...
  virtual void set_et_iso(const float, const int, bool, bool) { PHOOL_VIRTUAL_WARNING; }
  //  //! truth cluster's PHG4Particle ID
