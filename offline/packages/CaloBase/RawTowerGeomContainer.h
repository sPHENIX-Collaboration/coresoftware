...
class RawTowerGeomContainer : public PHObject
{
 public:
  ...
  virtual void set_etabounds(const int, const std::pair<double, double> &) { PHOOL_VIRTUAL_WARN("set_etabounds(const int ibin, const std::pair<double, double> & bounds)"); }
  virtual void set_phibounds(const int, const std::pair<double, double> &) { PHOOL_VIRTUAL_WARN("set_etabounds(const int ibin, const std::pair<double, double> & bounds)"); }
