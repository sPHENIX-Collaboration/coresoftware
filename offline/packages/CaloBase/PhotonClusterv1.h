...
//! PhotonClusterv1 - derives from both PhotonCluster and RawClusterv2
//! @warning Multiple inheritance used - be careful with method resolution
class PhotonClusterv1 : public PhotonCluster, public RawClusterv2
{
 public:
  ...
  //! Copy constructor from existing RawClusterv2 object
  //! @warning This will copy all RawClusterv1 data but initialize photon properties to defaults
  explicit PhotonClusterv1(const RawClusterv2& rawcluster);
  ...
  //! @{
  //! @warning Override methods from RawClusterv2 - virtual dispatch applies
  void Reset() override;
  ...
  // RawClusterv2 already provides energy and isolation energy accessors
 ...
 private:
  ...
  // Photon energy and isolation energy now sourced from RawClusterv2
