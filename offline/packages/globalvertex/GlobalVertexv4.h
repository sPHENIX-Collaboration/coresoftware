...
//  -*- C++ -*-.
#ifndef GLOBALVERTEX_GLOBALVERTEXV4_H
#define GLOBALVERTEX_GLOBALVERTEXV4_H
...
class GlobalVertexv4 : public GlobalVertex
{
 public:
  GlobalVertexv4() = default;
  GlobalVertexv4(const unsigned int id);
  ~GlobalVertexv4() override;
 ...
 private:
  ...
  ClassDefOverride(GlobalVertexv4, 3);
};
