...
//  -*- C++ -*-.
#ifndef GLOBALVERTEX_MBDVERTEXV3_H
#define GLOBALVERTEX_MBDVERTEXV3_H
...
class MbdVertexv3 : public MbdVertex
{
 public:
  MbdVertexv3() = default;
  ~MbdVertexv3() override = default;

  // PHObject virtual overloads
  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = MbdVertexv3(); }
  int isValid() const override;
  PHObject* CloneMe() const override { return new MbdVertexv3(*this); }
  ...
  // beam crossing methods (v3: native signed short storage)
 ...
 private:
  ...
  ClassDefOverride(MbdVertexv3, 1);
};
