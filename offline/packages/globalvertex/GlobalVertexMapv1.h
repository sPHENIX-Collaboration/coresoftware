...
class GlobalVertexMapv1 : public GlobalVertexMap
{
 public:
  ...
  std::vector<GlobalVertex*> get_gvtxs_with_type(GlobalVertex::VTXTYPE type) override;
  std::vector<const Vertex*> get_vtxs_of_type(GlobalVertex::VTXTYPE type) override;
