...
TruthVertexMap::ConstIter TruthVertexMap::find(unsigned int /*unused*/) const { return ConstIter(); }
TruthVertexMap::ConstIter TruthVertexMap::end() const { return ConstIter(); }

TruthVertexMap::Iter TruthVertexMap::begin() { return Iter(); }
TruthVertexMap::Iter TruthVertexMap::find(unsigned int /*unused*/) { return Iter(); }
