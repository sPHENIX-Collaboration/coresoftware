...
//  -*- C++ -*-.
#ifndef GLOBALVERTEX_CALOVERTEXV1_H
#define GLOBALVERTEX_CALOVERTEXV1_H
...
class CaloVertexv1 : public CaloVertex
{
 public:
  CaloVertexv1() = default;
  ~CaloVertexv1() override = default;

  // PHObject virtual overloads

  void identify(std::ostream& os = std::cout) const override;
  void Reset() override { *this = CaloVertexv1(); }
  int isValid() const override;
  PHObject* CloneMe() const override { return new CaloVertexv1(*this); }
 ...
 private:
  ...
  ClassDefOverride(CaloVertexv1, 1);
};
