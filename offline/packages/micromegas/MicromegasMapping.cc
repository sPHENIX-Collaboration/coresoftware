...
void MicromegasMapping::construct_channel_mapping()
{
  ...
  // map mec8 channel id (1-70) to mec8 signal id on detector as defined by audrey in z views
  /* sources:
   * https://wiki.sphenix.bnl.gov/index.php/File:HDR-225938-XX.PNG.png
   * https://wiki.sphenix.bnl.gov/index.php/File:HDR-225940-XX.PNG.png
  ...
  // map all mec8 channel id to signal id on detector as defined by audrey in z views
  /* sources:
   * https://indico.bnl.gov/event/19038/contributions/75495/attachments/47029/79750/MappingGerber.pdf
   * https://indico.bnl.gov/event/17391/contributions/68961/attachments/47061/79816/TpotProgress.pdf, slide 2
   */
  ...
  std::map<int,int> mec8_to_signal_mapping_phi = {
    ...
    {1,-1},
    {3,33},  {5,34},  {7,35},  {9,36},  {11,37}, {13,38}, {15,39}, {17,40},
    {19,41}, {21,42}, {23,43}, {25,44}, {27,45}, {29,46}, {31,47}, {33,48},
    {35,-1},
    {37,49}, {39,50}, {41,51}, {43,52}, {45,53}, {47,54}, {49,55}, {51,56},
    {53,57}, {55,58}, {57,59}, {59,60}, {61,61}, {63,62}, {65,63}, {67,64},
    {69,-1},
    ...
    {20,9}, {22,10}, {24,11}, {26,12}, {28,13}, {30,14}, {32,15}, {34,16},
    {36,-1},
    {38,17}, {40,18}, {42,19}, {44,20}, {46,21}, {48,22}, {50,23}, {52,24},
    {54,25}, {56,26}, {58,27}, {60,28}, {62,29}, {64,30}, {66,31}, {68,32},
    {70,-1}
  };
