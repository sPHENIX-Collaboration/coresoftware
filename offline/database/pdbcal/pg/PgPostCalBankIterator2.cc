#include <PgPostCalBankIterator2.h>
...
PgPostCalBankIterator2::PgPostCalBankIterator2(PgPostBankManager& bm)
  :
  fBM(bm),
  fApplication(0),
  fDBName(""),
...
//_____________________________________________________________________________
PgPostCalBankIterator2::~PgPostCalBankIterator2()
{
...
//_____________________________________________________________________________
bool
PgPostCalBankIterator2::init(const char* fulldbname, const PdbBankID2& bankid2)
{
  fDBName=fulldbname;
  fBankID2=bankid2;
  ...
  if ( fBankID2.getInternalValue() != -1 )
    {
      query << " where bankID = " 
	    << bankid2.getInternalValue();
    }
...
//_____________________________________________________________________________
bool
PgPostCalBankIterator2::isValid() const
{
  return fIsValid;
}
...
//_____________________________________________________________________________
void
PgPostCalBankIterator2::print(std::ostream& os) const
{
  TimeMap::const_iterator it;

  os << "PgPostCalBankIterator2 for database " 
     << fDBName << " and BankID " << fBankID2.getInternalValue()
     << " (table=" << fTableName << ")"
     << std::endl;
...
//_____________________________________________________________________________
void
PgPostCalBankIterator2::setBankID2(const PdbBankID2& id)
{
  fBankID2 = id;
}
...
//_____________________________________________________________________________
void
PgPostCalBankIterator2::setEndValTimeLimits(const PHTimeStamp& min,
...
//_____________________________________________________________________________
void
PgPostCalBankIterator2::setInsertTimeLimits(const PHTimeStamp& min,
					    const PHTimeStamp& max)
{
...
//_____________________________________________________________________________
void
PgPostCalBankIterator2::setStartValTimeLimits(const PHTimeStamp& min,
    const PHTimeStamp& max)
{
