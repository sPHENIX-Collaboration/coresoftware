...
//_____________________________________________________________________________
bool
PgPostCalBankIterator::isValid() const
{
  return fIsValid;
}
...
//_____________________________________________________________________________
void
PgPostCalBankIterator::print(std::ostream& os) const
{
...
//_____________________________________________________________________________
void
PgPostCalBankIterator::setBankID(const PdbBankID& id)
{
  fBankID = id;
}
...
//_____________________________________________________________________________
void
PgPostCalBankIterator::setEndValTimeLimits(const PHTimeStamp& min,
...
//_____________________________________________________________________________
void
PgPostCalBankIterator::setInsertTimeLimits(const PHTimeStamp& min,
					    const PHTimeStamp& max)
{
...
//_____________________________________________________________________________
void
PgPostCalBankIterator::setStartValTimeLimits(const PHTimeStamp& min,
    const PHTimeStamp& max)
{
