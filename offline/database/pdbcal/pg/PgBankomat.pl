...
if ($className =~ /PgPost/)
{
#strip the . since we are called with either .hh or .cc
    @sp1 = split(/\./, $className);
    $bankName = $sp1[0];
    $pdbname = $sp1[0];
...
# Write  bank ddl-file
#
open (BANKHEADER, ">$bankName.hh") || die "cannot open bank header file $bankName.ddl\n";
...
print BANKHEADER "\n";
print BANKHEADER "#include \"PgPostCalBank.hh\"\n";
print BANKHEADER "#include <pdbcalbase/$pdbname.hh>\n";
...
print BANKHEADER "   \n";
print BANKHEADER "  virtual $bankName* clone() const;\n";
...
print BANKIMP "//-----------------------------------------------------------------------------\n";
print BANKIMP "#include \"$bankName.hh\"\n";
print BANKIMP "#include <pdbcalbase/PdbClassMap.hh>\n";
...
print BANKIMP "}\n";
print BANKIMP "\n";
print BANKIMP "$bankName* $bankName\:\:clone() const\n";
print BANKIMP "{\n";
