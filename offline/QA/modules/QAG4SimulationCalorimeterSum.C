...
QAG4SimulationCalorimeterSum::QAG4SimulationCalorimeterSum(string calo_name,
    QAG4SimulationCalorimeterSum::enu_flags flags) :
    SubsysReco("QAG4SimulationCalorimeterSum_" + calo_name), //
...
int
QAG4SimulationCalorimeterSum::Init_G4Hit(PHCompositeNode *topNode)
{
...
int
QAG4SimulationCalorimeterSum::process_event_G4Hit(PHCompositeNode *topNode)
{

  if (verbosity > 2)
    cout << "QAG4SimulationCalorimeterSum::process_event_G4Hit() entered" << endl;
  ...
  if (verbosity > 2)
    {
      cout
          << "QAG4SimulationCalorimeterSum::process_event_G4Hit() handle this truth particle"
          << endl;
  ...
  if (verbosity > 2)
    {
      cout
          << "QAG4SimulationCalorimeterSum::process_event_G4Hit() handle this vertex"
          << endl;
  ...
  if (verbosity > 3)
    cout << "QAG4SimulationCalorimeterSum::process_event_G4Hit::" << _calo_name
...
QAG4SimulationCalorimeterSum::process_event_Tower(PHCompositeNode *topNode)
{
  ...
  if (verbosity > 2)
    cout << "QAG4SimulationCalorimeterSum::process_event_Tower() entered" << endl;
...
QAG4SimulationCalorimeterSum::process_event_Cluster(PHCompositeNode *topNode)
{
  ...
  if (verbosity > 2)
    {
      cout
          << "QAG4SimulationCalorimeterSum::process_event_Cluster() handle this truth particle"
          << endl;
      last_primary->identify();
    }
  ...
  if (cluster)
    {
      ...
      if (verbosity > 2)
        {
          cout
              << "QAG4SimulationCalorimeterSum::process_event_Cluster() handle this vertex"
              << endl;
          primary_vtx->identify();
        }
