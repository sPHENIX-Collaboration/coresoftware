...
void
TDirectoryHelper::copyToFile(TDirectory* src, TFile* dest)
{
...
//_____________________________________________________________________________
void 
TDirectoryHelper::duplicateDir(TDirectory* dest, TDirectory* source)
{
  dest->cd();
...
//_____________________________________________________________________________
bool 
TDirectoryHelper::mkpath(TDirectory* dir, const string& path)
{
...
//_____________________________________________________________________________
bool 
TDirectoryHelper::pathIsInDir(const string& path, TDirectory* dir)
{
...
//_____________________________________________________________________________
TH1* 
TDirectoryHelper::getHisto(TDirectory* dir, const string& histoname, 
			   const string& where)
{
...
//_____________________________________________________________________________
void 
TDirectoryHelper::splitPath(const string& path, 
			    std::vector<std::string>& paths)
{
