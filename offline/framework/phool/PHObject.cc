...
void 
PHObject::identify(std::ostream& out) const
{
...
int 
PHObject::isValid(const float) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isValid(const double) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isValid(const int) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isValid(const unsigned int) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isImplemented(const float) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isImplemented(const double) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isImplemented(const int) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
...
int 
PHObject::isImplemented(const unsigned int) const
{
  // give warning if this method is not implemented
  std::cout << PHWHERE 
