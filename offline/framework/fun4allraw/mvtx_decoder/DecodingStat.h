...
// @sa <O2/Detectors/ITSMFT/common/reconstruction/include/ITSMFTReconstruction/DecodingStat.h>
//     <5ca140c87>
...
namespace mvtx_offline
{
  ...
  struct ChipStat
  {
    ...
    ChipStat() = default;
    explicit ChipStat(uint16_t _feeID)
      : feeID(_feeID)
    {
    }
