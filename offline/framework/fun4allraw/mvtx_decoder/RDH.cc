...
mvtx_offline::RDHAny::RDHAny(int v)
{
  if (v == 0)
  {
    *this = RDH{};
...
//_________________________________________________
void mvtx_offline::RDHAny::copyFrom(const void* rdh)
{
...
#if __cplusplus >= 202002L
//_________________________________________________
void mvtx_offline::RDHUtils::printRDH(const RDHv8& rdh)
{
...
//_________________________________________________
void mvtx_offline::RDHUtils::printRDH(const void* rdhP)
{
...
//_________________________________________________
#if __cplusplus >= 202002L
void mvtx_offline::RDHUtils::dumpRDH(const void* rdhP)
{
...
//_________________________________________________
bool mvtx_offline::RDHUtils::checkRDH(const void* rdhP, bool verbose, bool checkZeros)
{
  int version = getVersion(rdhP);
  bool ok = true;
...
bool mvtx_offline::RDHUtils::checkRDH(const RDHv8& rdh, bool verbose, bool checkZeros)
{
