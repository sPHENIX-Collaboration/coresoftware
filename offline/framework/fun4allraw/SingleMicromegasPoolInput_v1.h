...
class SingleMicromegasPoolInput_v1 : public SingleStreamingInput
{
 public:
  explicit SingleMicromegasPoolInput_v1(const std::string &name = "SingleMicromegasPoolInput_v1");
  ~SingleMicromegasPoolInput_v1() override;
