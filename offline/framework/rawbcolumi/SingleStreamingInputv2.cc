...
SingleStreamingInputv2::SingleStreamingInputv2(const std::string &name)
  : Fun4AllBase(name)
{
}

SingleStreamingInputv2::~SingleStreamingInputv2()
{
  delete m_EventIterator;
}

int SingleStreamingInputv2::fileopen(const std::string &filenam)
{
...
int SingleStreamingInputv2::fileclose()
{
  if (!IsOpen())
  {
...
void SingleStreamingInputv2::Print(const std::string &what) const
{
...
bool SingleStreamingInputv2::CheckPoolDepth(const uint64_t bclk)
{
...
void SingleStreamingInputv2::ClearCurrentEvent()
{
