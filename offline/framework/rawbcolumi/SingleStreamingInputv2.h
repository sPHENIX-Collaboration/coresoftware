#ifndef RAWBCOLUMI_SINGLESTREAMINGINPUTV2_H
#define RAWBCOLUMI_SINGLESTREAMINGINPUTV2_H
...
class SingleStreamingInputv2 : public Fun4AllBase, public InputFileHandler
{
 public:
  explicit SingleStreamingInputv2(const std::string &name);
  ~SingleStreamingInputv2() override;
  ...
  // virtual void StreamingInputManager(Fun4AllStreamingLumiCountingInputManager *in) { m_StreamingLumiInputMgr = in; }
